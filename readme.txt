...
No Skim can be found and installed via the Plugin menu within WordPress administration. Alternatively, it can be downloaded and installed manually...
...
Most times you'll need to use this, I suspect, will be to suppress Skimlinks across an entire post or page, rather than just a section of it. I therefore want to add a meta box that will allow you to simply a box to switch it off for the post/page, to save having to use the shortcode.
